        ...
        <Document>
            <Page style={styles.body}>
                ...
                <Text style={styles.subtitle}>
                    <br />1. Tell us the differences between uncontrolled and controlled components. <br />
                </Text>
                <Text style={styles.text}>
                    In React, controlled components refer to components that have their state and behavior controlled by the parent component. These components rely on props passed down from the parent component to update their state and behavior. Uncontrolled components refer to components that manage their own state internally.
                </Text>
                <Text style={styles.subtitle}>
                    <br />2. How to validate React props using PropTypes <br />
                </Text>
                <Text style={styles.text}>
                    PropTypes are simply a mechanism that ensures that the passed value is of the correct datatype. This makes sure that we don't receive an error at the very end of our app by the console which might not be easy to deal with.
                </Text>
                <Text style={styles.subtitle}>
                    <br />3. Tell us the difference between nodejs and express js. <br />
                </Text>
                <Text style={styles.text}>
                ...
                <Text style={styles.subtitle}>
                    <br />4. What is a custom hook, and why will you create a custom hook? <br />
                </Text>
                <Text style={styles.text}>
